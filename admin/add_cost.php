      ...
      <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Cost Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            include('database/admin.php');
             include('database/area.php');
           
            $bus=new Admin();
                   $data=$bus->get_bus();
            //$stopage=$bus->stopageList($id)

            $startData=$bus->stopageStart(); 
            if($_SERVER['REQUEST_METHOD']=='POST'){
                extract($_POST);
                //print_r($_POST);
               $insert=$bus->add_bus_cost($busName, $stopage, $stopage1, $cost);
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <div class="form-group">
                  <label for="stopage" class="col-sm-2 control-label">Start</label>
                  ...
                  <div class="col-sm-10">
                     ...
                     <?PHP while ($row2= mysqli_fetch_array($startData)){ ?>
                   ...
                   <div class="form-group">
                  <label for="stopage" class="col-sm-2 control-label">End</label>

                  <div class="col-sm-10">



                      <select class="form-control" name="stopage1" id="stopage1">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="bus_name" placeholder="name" name="cost" required="">
                  </div>
                </div> 
